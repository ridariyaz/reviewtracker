...
class LanguageService
{
    private array $translations = [
        ...
        'bn' => [
            'dir' => 'ltr',
            'headline' => 'আপনার অভিজ্ঞতা কেমন ছিল?',
            'subheadline' => 'আপনার মতামত মাত্র ৫ সেকেন্ড সময় নেয় এবং আমাদের ভালো সেবা দিতে সাহায্য করে!',
            'great' => 'খুব ভালো!',
            'ok' => 'মোটামুটি',
            'bad' => 'উন্নতি প্রয়োজন',
            'improve_title' => 'আমরা কীভাবে উন্নতি করতে পারি বলুন',
            'improve_sub' => 'আপনার মতামত সরাসরি পরিচালকদের কাছে পাঠানো হবে।',
            'placeholder' => 'কী ভালো লেগেছে বা কী সংশোধন করা দরকার...',
            'submit' => 'মতামত পাঠান',
            'thankyou_title' => 'ধন্যবাদ!',
            'thankyou_sub' => 'আপনার মতামত পরিচালকদের কাছে জমা হয়েছে।',
            'multi_title' => 'কোথায় রিভিউ দিতে চান?',
            'multi_sub' => 'নিচের প্ল্যাটফর্ম নির্বাচন করুন:',
            'post_on' => 'রিভিউ দিন',
        ],
    ];
